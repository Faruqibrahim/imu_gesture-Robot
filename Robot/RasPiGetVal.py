...
def main():
    ...
    MQTT_USERNAME = "imuRasPi" # The username of the RasPi (it was set for the mqtt server manually) sudo mosquitto_passwd -c /etc/mosquitto/passwd your_username
    MQTT_PASSWORD = "imurobot" # The password for the RasPi username (was also set for the mqtt server manually)
